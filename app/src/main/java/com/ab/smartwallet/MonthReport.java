...
public class MonthReport extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        month = (Spinner) v.findViewById(R.id.MonthM);
        year = (Spinner) v.findViewById(R.id.MonthY);
        ok = (Button) v.findViewById(R.id.mok);
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                for (int i = 0; i < income.size(); i++) {
                    ...
                    if ( m == Integer.parseInt(month.getSelectedItemId()+1+"")
                ...
                PieChart chart = (PieChart) v.findViewById(R.id.monthChart);
